...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.40\textheight,keepaspectratio]{create_it_catalog.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.40\textheight,keepaspectratio]{catalog_categories.png}
